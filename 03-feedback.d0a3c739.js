...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a={form:document.querySelector(".feedback-form")},l=a.form.elements.email,r=a.form.elements.message;function o(e){const t={email:l.value,message:r.value};localStorage.setItem("feedback-form-state",JSON.stringify(t))}function s(){const e=JSON.parse(localStorage.getItem("feedback-form-state"));e&&(l.value=e.email,r.value=e.message)}function u(e){if(e.preventDefault(),!l.value||!r.value)return alert("All feels must be fell out!");console.log({email:l.value,message:r.value}),e.currentTarget.reset(),localStorage.removeItem("feedback-form-state")}a.form.addEventListener("input",(0,e.default)(o,500)),a.form.addEventListener("submit",u),s();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.d0a3c739.js.map